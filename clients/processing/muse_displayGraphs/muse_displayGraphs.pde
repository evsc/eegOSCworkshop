...
void draw() {
  if (!pause) {
    ...
    if(display == 1) {
      ...
      drawTimeSeries(50,520, 1100,270, 5, true, true);  // relative
      ...
      drawTimeSeriesStatus(50,780, 1100, 30);
      drawTimeSeriesTime(50,810, 1100, 30);
      //drawExpGraph(50,750, 1100, 70);
  ...
  for(int i=0; i<5; i++) {
    ...
    if (m > 50) {
      for(int h2=50; h2<m; h2++) {
        Sample sample = (Sample) samples.get(samples.size()-h2-1);
